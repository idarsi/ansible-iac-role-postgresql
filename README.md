...
Clients that connect to the REST API still need a client certificate when
`verify_client` is `optional` or `required`; external operator client
certificates remain the responsibility of the surrounding PKI.
